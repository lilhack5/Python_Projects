...
def load_gui(self):
    ...
    self.btn_update = tk.Button(self.master,width=12,height=2,text='Update',command=lambda: phonebook.func.onUpdate(self))
    ...
    self.btn_close = tk.Button(self.master,width=12,height=2,text='Close',command=lambda: phonebook.func.ask_quit(self))
