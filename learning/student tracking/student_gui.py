...
def load_gui(self):
    ...
    self.lbl_fname.grid(row=0,column=0,padx=(25,0),pady=(11,0),sticky=N+W)
    self.lbl_lname = tk.Label(self.master,text='Last Name: ')
    self.lbl_lname.grid(row=2,column=0,padx=(25,0),pady=(11,0),sticky=N+W)
    self.lbl_phone = tk.Label(self.master,text='Phone Number: ')
    self.lbl_phone.grid(row=4,column=0,padx=(25,0),pady=(11,0),sticky=N+W)
    self.lbl_email = tk.Label(self.master,text='Email Address: ')
    self.lbl_email.grid(row=6,column=0,padx=(25,0),pady=(11,0),sticky=N+W)
    self.lbl_course = tk.Label(self.master,text='Current Course: ')
    self.lbl_course.grid(row=8,column=0,padx=(25,0),pady=(11,0),sticky=N+W)
    self.lbl_user = tk.Label(self.master,text='User: ')
    self.lbl_user.grid(row=0,column=2,padx=(0,0),pady=(11,0),sticky=N+W)
